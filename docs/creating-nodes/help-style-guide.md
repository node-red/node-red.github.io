...
*Caution* When creating markdown help text be careful with indentation, markdown is whitespace sensitve so all lines should have no leading whitespace inside the `<script>` tags.
