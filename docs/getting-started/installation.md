...
You can get the latest Long Term Support (LTS) version of Node <code>4.x</code> from:
 ...
 - Linux Binaries: [32-bit](https://nodejs.org/dist/latest-v4.x/node-v4.4.6-linux-x86.tar.gz)
                   or
                   [64-bit](https://nodejs.org/dist/latest-v4.x/node-v4.4.6-linux-x64.tar.gz)
 - Max OS X Installer: [Universal](https://nodejs.org/dist/latest-v4.x/node-v4.4.6.pkg)
 - Windows Installer: [32-bit](https://nodejs.org/dist/latest-v4.x/node-v4.4.6-x86.msi)
                      or
                      [64-bit](https://nodejs.org/dist/latest-v4.x/node-v4.4.6-x64.msi)
